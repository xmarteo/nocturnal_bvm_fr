...
%% TODO Pater sans partition
{Notre Père...\\Et ne nous laisse pas entrer en tentation.\\Mais délivre-nous du Mal.}

\smalltitle{Absolution}
%% TODO Absolution sans partition

{Seigneur Jésus-Christ, exauce les prières de tes serviteurs, et aie pitié de nous,
...
%% TODO Jube dom(i)ne sans partition
\rubric{Bén.} Que le Père éternel nous bénisse d'une bénédiction perpétuelle.\\
\rubric{\rrrub} Amen.

%% TODO tu autem sans partition
{Et toi, Seigneur, aie pitié de nous. \rubric{\rrrub} Nous rendons grâces à Dieu.}
...
\vvrub{} Ora pro pópulo, intérveni pro clero, intercéde pro devóto femíneo sexu: séntiant omnes tuum juvámen, quicúmque célebrant tuam sanctam festivitátem.}{Vous êtes heureuse, sainte Vierge Marie, et grandement digne de toute louange :
\psstar{} Car c’est de vous qu’est sorti le soleil de justice, le Christ notre Dieu.
\vvrub{} Priez pour le peuple, intervenez en faveur du clergé, intercédez pour les femmes consacrées par vœu ; qu’ils éprouvent tous votre assistance, ceux qui célèbrent votre sainte fête.}
...
%% TODO DV sans chant
{\rubric{\vvrub} Le Seigneur soit avec vous.\\\rubric{\rrrub} Et avec votre esprit.\\\rubric{\vvrub} Prions.}

\rubric{Ou bien, si l'officiant n'est pas au moins diacre:}

%% TODO DE sans chant
{\rubric{\vvrub} Seigneur, exauce ma prière.\\\rubric{\rrrub} Et que mon cri parvienne jusqu'à toi.\\\rubric{\vvrub} Prions.}
